  ...
  <div ref="contentBox" class="content-box">
    <cu-animation :type="'slideInRight'" :time="0.5">
      <div class="content_button">
        <el-button type="primary" class="Hover buttonOne"
          >导出申请列表</el-button
        >
        <el-button type="primary" class="Hover buttonTwo">添加专利</el-button>
    ...
    <cu-animation :type="'slideInRight'" :time="0.5">
      <div class="centent_table">
        ...
        >
          <template #tableTop>
            <div class="spanList">
              资助金额合计：<span class="spanFour">0.00</span>元
            </div>
          </template>
          <template #url="value">
            <el-image
